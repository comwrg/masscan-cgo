...
func main() {
	arr := [...]*C.char{C.CString("masscan"), C.CString("-p"), C.CString("80"), C.CString("1.1.1.1")}
	C.scan(C.int(len(arr)), (**C.char)(unsafe.Pointer(&arr)))
}
